...
# Função auxiliar para normalizar os nomes das teclas para o pyautogui
...
class MacroApp:
    def __init__(self, root):
        ...
        # Dicionários para listas carregadas (chave: caminho completo, valor: lista de itens)
        self.loaded_lists = {}
        self.loaded_index = {}
    ...
    # --- Edição de clique (com radio buttons) ---
    ...
    # --- Edição de tecla (com botão Limpar) ---
    ...
    # --- Edição de espera (só aceita números) ---
    ...
    # --- Funções para criar eventos (capturar clique, adicionar texto, tecla, espera, etc.) ---
